...
1. **GMI-PAN**  
   ...
   - Integrated open-source tools for assembly, annotation, and phylogenetic reconstruction  
...
2. **FADS – Fluorescence Activated Droplet Sorting**  
   ...
   - Integrated laser modules via RS-232 communication protocol  
...
4. **"Franklin" – DIY Linux Storage Server (GMI Lab)**  
   ...
   - Applied sustainable hardware reuse practices aligned with right-to-repair principles  
...
Revisiting fundamentals is never a waste of time.
